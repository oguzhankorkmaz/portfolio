export const EXPERIENCE = [
  {
    ...
    logo: "/images/experience/sonicwall_logo.png",
    company_info:
  ...
  },
   {
    ...
    company_info:
      "crewin is an industry-specific Crew Matching & Candidate Sourcing Pre-Recruitment Job Board that begins with Maritime Industry.",
    company_name: "Crewin",
    positions: [
      {
